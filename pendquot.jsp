...
<html>
<body>
<form name=frm action="/nontrading/rec_order.jsp" method=post">


<h3>Pending Qoutation List: 
  <h3><br>
<table border=2 width=100%>
<tr><td>Order Recd for</td><td>Quotation No.</td><td>Quot. Date </td><td>Customer Name</td><td>Cust. Tel No.</td><td>Item1</td><td>Item2</td><td>Total Value</td></tr>
...
{}
%></table><input type=submit value="Received Orders"></form>
</h3></h3></body></html>